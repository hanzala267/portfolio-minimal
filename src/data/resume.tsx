...
export const DATA = {
  ...
  summary:
    "I am a Software Engineer from NTU Pakistan with over two years of hands-on experience in modern web development. I have successfully delivered numerous real-world projects for clients through internships and freelance work. Additionally, I have served twice as a teaching assistant for web development courses at NTU, where I supported students in mastering contemporary web technologies. My expertise lies in full-stack development, with a strong focus on front-end technologies. I am proficient in React, Next.js, and Tailwind CSS, and I have a solid understanding of back-end technologies such as Node.js and Express.js. I am also well-versed in database management with PostgreSQL and MongoDB. My passion for coding drives me to continuously learn and adapt to new challenges in the ever-evolving tech landscape.",
  avatarUrl: "/me.png",
  skills: [
    "React",
    "Next.js",
